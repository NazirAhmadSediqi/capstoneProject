...
import pageObjects.LaptopAndNoteBookPageObjects;
import utilities.WebDriverUtility;

public class LaptopAndNoteBookStepDefinitions extends Base{
	
	LaptopAndNoteBookPageObjects laptop = new LaptopAndNoteBookPageObjects();
	...
	public void user_click_on_heart_icon_to_add_Sony_VaIO_laptop_to_wish_list() throws Throwable {
	   laptop.clickOnheartIconSonyVaio();
	}
